...
def train():
    ...
    # set model
    if 'frustum_pointnets' in MODEL_FILE:
...
if __name__ == "__main__":
    ...
    **** EPOCH 013 ****
    ...
    our FLAGS:
    Namespace(batch_size=32, ckpt=None, decay_rate=0.7, decay_step=20, learning_rate=0.001, log_dir='log', max_epoch=201, model='frustum_pointnets', momentum=0.9, name='logitswodetach_lr1e-3_ds20_dr0.7', no_intensity=False, num_point=1024, optimizer='adam', restore_model_path=None, return_all_loss=True, weight_decay=0.0001)
    **** EPOCH 001 ****
    Epoch 1/201:
